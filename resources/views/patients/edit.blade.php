        ...
        <div class="card-body">
          ...
          <form action="{{ url('/pacientes/'.$patient->id) }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" value="{{ old('name', $patient->name) }}" required autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="cedula" class="form-control" value="{{ old('cedula', $patient->cedula) }}" autocomplete="off"/>
            </div>
            ...
            <button type="submit" class="btn btn-sm btn-success">Editar Paciente</button>
